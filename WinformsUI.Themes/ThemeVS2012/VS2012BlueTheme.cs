...
namespace WeifenLuo.WinFormsUI.Docking
{
    ...
    public class VS2012BlueTheme : VS2012ThemeBase
    {
        public VS2012BlueTheme()
            : base(Decompress(WinformsUI.Themes.ThemeVS2012.Resources.vs2012blue_vstheme), new VS2013DockPaneSplitterControlFactory(), new VS2013WindowSplitterControlFactory())
        {
